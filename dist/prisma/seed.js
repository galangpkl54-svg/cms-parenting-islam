...
const demoPosts = [
    {
        ...
        excerpt: "Contoh artikel utama untuk homepage, dibuat dengan struktur heading, kata kunci natural, dan copy yang jelas agar mudah dibaca sekaligus ramah mesin pencari.",
        content: `
      <p>Jika Anda baru mengisi CMS blog, langkah paling cepat untuk melihat hasil yang bagus adalah menyiapkan artikel yang punya struktur rapi, judul yang spesifik, dan deskripsi yang relevan.</p>
      <p>Artikel ini memakai pendekatan <strong>SEO on-page</strong> sederhana: satu topik utama, subtopik yang saling mendukung, dan ajakan baca yang jelas. Hasilnya, halaman terlihat penuh, profesional, dan lebih siap untuk diindeks.</p>
      <h2>Fokus utama</h2>
      <ul>
        <li>Gunakan satu keyword utama di judul dan paragraf pembuka</li>
        <li>Tambahkan heading yang menjelaskan isi dengan jelas</li>
        <li>Isi meta description dengan ringkasan yang natural</li>
        <li>Pastikan internal link mengarah ke artikel terkait</li>
      </ul>
      <h2>Contoh susunan yang baik</h2>
      <p>Mulai dengan pembuka yang menjawab kebutuhan pembaca, lanjutkan dengan penjelasan praktis, lalu tutup dengan ringkasan yang mudah dipahami. Pola seperti ini cocok untuk blog company, portal berita, maupun konten edukasi.</p>
      <p>Dengan isi seperti ini, halaman depan langsung terasa hidup, dan admin panel juga lebih meyakinkan saat Anda membuka daftar artikel.</p>
    `,
    ...
    },
    {
        ...
        excerpt: "Kategori dan tag yang konsisten membantu navigasi, memperjelas topik, dan mendukung struktur situs yang lebih mudah dipahami mesin pencari.",
        content: `
      <p>Struktur kategori yang baik membuat pembaca lebih cepat menemukan topik yang relevan. Tag kemudian dipakai untuk menghubungkan artikel yang masih satu tema, tanpa membuat arsip menjadi terlalu sempit.</p>
      <h2>Prinsip sederhana</h2>
      <ul>
        <li>Gunakan kategori untuk topik besar</li>
        <li>Gunakan tag untuk detail, istilah, atau teknik</li>
        <li>Jangan membuat tag terlalu banyak dan mirip</li>
        <li>Jaga nama kategori tetap singkat dan konsisten</li>
      </ul>
      <p>Contoh implementasi seperti ini membuat arsip kategori dan tag terlihat lebih matang. Halaman juga jadi lebih baik untuk SEO karena hubungan antar konten mudah dibaca.</p>
    `,
    ...
    },
    {
        ...
        excerpt: "Halaman yang cepat biasanya punya gambar yang ringan, layout yang stabil, dan komponen yang tidak memaksa browser bekerja terlalu berat.",
        content: `
      <p>Kecepatan halaman adalah faktor penting yang memengaruhi pengalaman pengguna dan performa organik. Blog yang lambat terlihat kurang profesional, meski isi artikelnya bagus.</p>
      <h2>Hal yang paling berdampak</h2>
      <ol>
        <li>Kompres gambar sebelum diunggah</li>
        <li>Gunakan ukuran media yang sesuai kebutuhan tampilan</li>
        <li>Hindari script yang tidak perlu pada halaman publik</li>
        <li>Pastikan layout stabil saat konten dimuat</li>
      </ol>
      <p>Di CMS seperti ini, halaman yang ringan membuat pembaca lebih lama bertahan. Itu membantu performa konten dan mengurangi bounce yang tidak perlu.</p>
    `,
    ...
    },
    {
        ...
        excerpt: "Konten evergreen memberi nilai jangka panjang karena tetap relevan, terus bisa diperbarui, dan biasanya lebih stabil mendatangkan traffic.",
        content: `
      <p>Konten evergreen adalah jenis artikel yang tidak cepat usang. Topiknya cenderung bertahan lama dan bisa terus dioptimasi tanpa harus ditulis ulang dari nol.</p>
      <h2>Checklist sebelum publish</h2>
      <ul>
        <li>Pastikan topik memang dicari secara konsisten</li>
        <li>Tambahkan contoh praktis yang mudah diterapkan</li>
        <li>Buat intro yang menjelaskan manfaat artikel</li>
        <li>Siapkan bagian pembaruan saat data berubah</li>
      </ul>
      <p>Dengan pendekatan ini, artikel demo Anda tidak hanya terlihat penuh, tetapi juga terasa seperti konten yang sengaja disusun untuk jangka panjang.</p>
    `,
    ...
    },
    {
        ...
        excerpt: "Internal linking membantu pembaca bergerak ke artikel lain yang relevan sekaligus memperkuat konteks topik di mata mesin pencari.",
        content: `
      <p>Internal linking sering dianggap detail kecil, padahal dampaknya besar. Link yang tepat membuat pembaca menemukan halaman terkait dan membantu mesin pencari memahami hubungan antar konten.</p>
      <h2>Cara menyusun link</h2>
      <ul>
        <li>Hubungkan artikel pilar dengan artikel pendukung</li>
        <li>Gunakan anchor text yang deskriptif</li>
        <li>Jangan mengulang link yang sama terlalu sering</li>
        <li>Tempatkan link di bagian yang memang relevan</li>
      </ul>
      <p>Struktur seperti ini sangat cocok untuk CMS blog yang ingin terlihat matang sejak data demo pertama kali dimasukkan.</p>
    `,
    ...
    },
    {
        ...
        excerpt: "Admin yang nyaman tidak hanya enak dilihat, tetapi juga mempercepat kerja editor saat menulis, mengatur media, dan memeriksa status artikel.",
        content: `
      <p>Desain admin yang baik membantu tim konten bekerja lebih cepat. Prioritas utamanya adalah keterbacaan, alur aksi yang jelas, dan komponen yang tidak berlebihan.</p>
      <h2>Yang perlu dijaga</h2>
      <ul>
        <li>Menu mudah dipahami</li>
        <li>Form penulisan tidak terlalu padat</li>
        <li>Status artikel terlihat jelas</li>
        <li>Preview konten membantu sebelum publish</li>
      </ul>
      <p>Contoh data seperti ini membuat dashboard dan daftar post terlihat penuh, bukan kosong, sehingga hasil implementasi lebih mudah dievaluasi.</p>
    `,
    ...
    },
    {
        ...
        excerpt: "Draft ini sengaja dibiarkan belum terbit supaya status draft tetap terlihat jelas di admin panel.",
        content: `
      <p>Ini contoh draft untuk menguji tampilan artikel yang belum publish.</p>
      <p>Isi draft tetap singkat agar perbedaan antara draft dan published mudah terlihat pada dashboard.</p>
    `,
...
async function ensurePost(authorId, post, categoryIds, tagIds) {
    ...
    const payload = {
        ...
        status: post.status,
        publishedAt: post.status === client_1.PostStatus.PUBLISHED ? post.publishedAt : null,
...
async function main() {
    ...
    const posts = await Promise.all(demoPosts.map((post) => ensurePost(admin.id, post, post.categories.map((slug) => categoryMap.get(slug)).filter(Boolean), post.tags.map((slug) => tagMap.get(slug)).filter(Boolean))));
    ...
    const publishedPosts = posts.filter((post) => post.status === client_1.PostStatus.PUBLISHED);
    ...
    console.log(`Seeded demo content for ${env_1.env.NODE_ENV} as ${adminEmail}`);
}
main()
    .catch((error) => {
    console.error(error);
